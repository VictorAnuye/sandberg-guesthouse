...
export default function Footer () {
    return (
        <footer className="flex flex-col gap-6 py-10 px-2 md:px-6 lg:px-12 bg-gray-500">
            ...
            <div>
                <p className="text-xs text-gray-200 text-center">&copy;2024 Sanberg Guest Limited. All Rights Reserved</p>
            </div>
        </footer>
    )
}